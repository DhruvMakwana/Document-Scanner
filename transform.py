...
def order_points(pts):
	#initialzie a list of coordinates that will be ordered such that the first entry in 
	#the list is the top-left, the second entry is the top-right, the third is the 
	...
	#smallest difference, whereas the bottom-left will have the largest difference
